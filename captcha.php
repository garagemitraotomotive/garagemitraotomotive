...
session_name('IndoWapBlog');
	...
	*/
	...
	/*
		...
		in index.php
	*/
	$security_number = empty($_SESSION['captcha_code']) ? 'IWB' : $_SESSION['captcha_code'];
	...
	*/
	...
	/*
		...
		capcha image
	*/
	$text=imagettftext($img,16,rand(-10,10),rand(10,30),rand(25,35),$text_color,"inc/courbd.ttf",$image_text);
	/*
